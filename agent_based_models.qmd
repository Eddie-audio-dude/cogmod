...
<!--             demo_weight <- 1 / ((demonstrator_trait - matrix(rowMeans(demonstrator_trait), nrow = n_pop, ncol = n_demonstrators, byrow = FALSE))^(2 * conformity) + 1E-12) -->
...
<!-- ```{r} -->
<!-- sim <- continuous_transmission(n_pop = 1000, max_t = 200) -->
...
<!-- ```{r} -->
<!-- sim <- continuous_transmission(n_pop = 1000, max_t = 200, mean_init_status = 0.1) -->
...
<!-- ```{r} -->
<!-- sim <- continuous_transmission(n_pop = 1000, max_t = 100, n_demonstrators = 3, conformity = 1) -->
